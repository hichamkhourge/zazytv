...
VIEWTVY_IBOPLAYER_PLAYLIST_URL_ID_2 = os.getenv("VIEWTVY_IBOPLAYER_PLAYLIST_URL_ID_2", "")
VIEWTVY_IBOPLAYER_PLAYLIST_NAME_2 = os.getenv("VIEWTVY_IBOPLAYER_PLAYLIST_NAME_2", "ViewTVY 2")
...
def save_to_iboplayer(username, password, hostname, max_retries=3, iboplayer_account=1):
    ...
    if iboplayer_account == 2:
        ...
        playlist_url_id = VIEWTVY_IBOPLAYER_PLAYLIST_URL_ID_2
        playlist_name = VIEWTVY_IBOPLAYER_PLAYLIST_NAME_2
        cookie_var = "IBOPLAYER_COOKIE_2"
        url_id_var = "VIEWTVY_IBOPLAYER_PLAYLIST_URL_ID_2"
    else:
        cookie = IBOPLAYER_COOKIE
        playlist_url_id = VIEWTVY_IBOPLAYER_PLAYLIST_URL_ID
        playlist_name = VIEWTVY_IBOPLAYER_PLAYLIST_NAME
        cookie_var = "IBOPLAYER_COOKIE"
        url_id_var = "VIEWTVY_IBOPLAYER_PLAYLIST_URL_ID"
...
def main(user_id=None, callback_url=None, iboplayer_account=1):
    driver = get_driver()
    ...
    try:
        ...
        save_to_iboplayer(username, password, host, iboplayer_account=iboplayer_account)
...
Examples:
  ...
  python viewtvy_automation.py --iboplayer-account 2
        """,
    )
    ...
    main(user_id=args.user_id, callback_url=args.callback_url, iboplayer_account=args.iboplayer_account)
